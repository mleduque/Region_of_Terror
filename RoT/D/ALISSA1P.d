...
!Global("DlCadd","GLOBAL",2)~ THEN BEGIN 0
  SAY @0 
...
!AreaCheck("RA5610")
!AreaCheck("RA5611")
!AreaCheck("RA5620")~ THEN REPLY @4 DO ~EscapeAreaMove("AR0406",1320,1680,5)
SetGlobal("KickedOut","LOCALS",1)~ EXIT
  IF ~~ THEN REPLY @5 DO ~SetGlobal("KickedOut","LOCALS",1)~ EXIT
END

IF ~Global("KickedOut","LOCALS",1)
!Global("DlCadd","GLOBAL",2)~ THEN BEGIN 2
  SAY @6
